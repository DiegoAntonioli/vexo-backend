...
export const registerCompanyEmployees: RequestHandler = async (
  ...
  try {
    ...
    workSheetsData.slice(1).forEach((data, index) => {
      ...
      const employee = {
        firstName: data[0] ? data[0].toLowerCase() : "",
        lastName: data[1] ? data[1].toLowerCase() : "",
        personalEmail: data[2] ? data[2].toLowerCase() : "",
        corporateEmail: data[3] ? data[3].toLowerCase() : "",
        phone: phone ? phone : "",
        birthState: data[5] ? data[5].toLowerCase() : "",
        cpf: cpf ? cpf : "",
        birthDate: birthDate ? birthDate : undefined,
        gender: data[8] ? data[8].toLowerCase() : "",
        maritalStatus: data[9] ? data[9].toLowerCase() : "",
        numberOfChildren: data[10],
        nacionality: data[11] ? data[11].toLowerCase() : "",
        postalCode: data[12],
        street: data[13] ? data[13].toLowerCase() : "",
        addressNumber: data[14] ? data[14].toString().toLowerCase() : "",
        addressLine2: data[15] ? data[15].toLowerCase() : "",
        neighborhood: data[16] ? data[16].toLowerCase() : "",
        city: data[17] ? data[17].toLowerCase() : "",
        state: data[18] ? data[18].toLowerCase() : "",
        admissionDate: admissionDate ? admissionDate : undefined,
        roleTitle: data[20] ? data[20].toLowerCase() : "",
        roleField: data[21] ? data[21].toLowerCase() : "",
        salary: data[22],
        averageSalary12: data[23],
        eligibleToCredit: data[36]
          ? data[36].toLowerCase() === "s"
            ? true
            : false
          : false,
        creditLimit: data[37],
        ...
        pixKey: data[41] ? data[41].toString().toLowerCase() : "",
        dataIndex: index,
      };
